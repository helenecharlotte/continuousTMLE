...
*** Target time-specific survival probabilities
...
*** Target survival probabilities simultaneously across multiple time-points
...
*** Target cause-specific cumulative risk
...
*** Target cause-specific cumulative risks separately
...
*** Target cause-specific cumulative risks simultaneously 
...
*** Target cause-specific cumulative risks simultaneously across multiple time-points
